...
#define CONSTRAINT_CENTERING_X_PERCENT(VIEW, X_PERCENT) [NSLayoutConstraint constraintWithItem: VIEW attribute: NSLayoutAttributeCenterX relatedBy: NSLayoutRelationEqual toItem: [VIEW superview] attribute: NSLayoutAttributeCenterX multiplier:(2*X_PERCENT) constant:0.0f]
#define CONSTRAINT_CENTERING_Y_PERCENT(VIEW, Y_PERCENT) [NSLayoutConstraint constraintWithItem: VIEW attribute: NSLayoutAttributeCenterY relatedBy: NSLayoutRelationEqual toItem: [VIEW superview] attribute: NSLayoutAttributeCenterY multiplier:(2*Y_PERCENT) constant:0.0f]
...
#define MATCH_CENTERS(FROMVIEW, TOVIEW) INSTALL_CONSTRAINTS(DEFAULT_LAYOUT_PRIORITY, @"Match Center", CONSTRAINTS_ALIGNING_PAIR_CENTER(FROMVIEW, TOVIEW, 0))
#define MATCH_CENTERH(FROMVIEW, TOVIEW) INSTALL_CONSTRAINTS(DEFAULT_LAYOUT_PRIORITY, @"Match Center", CONSTRAINT_ALIGNING_PAIR_CENTERX(FROMVIEW, TOVIEW, 0))
#define MATCH_CENTERV(FROMVIEW, TOVIEW) INSTALL_CONSTRAINTS(DEFAULT_LAYOUT_PRIORITY, @"Match Center", CONSTRAINT_ALIGNING_PAIR_CENTERY(FROMVIEW, TOVIEW, 0))
...
#define ALIGN_PAIR_LEFT_NAMED(KR_NAME, VIEW1, VIEW2)       INSTALL_CONSTRAINTS(DEFAULT_LAYOUT_PRIORITY, KR_NAME, CONSTRAINT_ALIGNING_PAIR_LEFT(VIEW1, VIEW2, 0))
